...
export const signupSchema = Joi.object({
  ...
  password: Joi.string().required().max(50).message('O campo "nome" pode ter no máximo {{#limit}}) caracteres.').min(6).message('O campo "senha" pode ter no mínimo {{#limit}}) caracteres.'),
})